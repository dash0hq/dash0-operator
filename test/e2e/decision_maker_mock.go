...
var (
	...
	// Signal Control Edge Proxy is pointed at via Dash0SignalControl.spec.sampling.decisionMakerEndpoint.
...
// observed by the mock. Used by Signal Control wiring tests to assert that the Edge Proxy has
