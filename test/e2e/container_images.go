...
var (
	localImages = Images{
		...
		secretRefSatellite: ImageSpec{
			repository:    "secret-ref-satellite",
			tag:           tagLatest,
			pullPolicy:    "Never",
			dockerContext: "images",
			dockerfile:    "images/secretrefsatellite/Dockerfile",
		},
	}
	...
	emptyImages = Images{
		...
		secretRefSatellite: ImageSpec{
			...
			tag:           "",
			pullPolicy:    "",
			dockerContext: localImages.secretRefSatellite.dockerContext,
			dockerfile:    localImages.secretRefSatellite.dockerfile,
		},
	}
...
func rebuildAllContainerImages() {
	...
	rebuildLocalImage(images.secretRefSatellite)
}
