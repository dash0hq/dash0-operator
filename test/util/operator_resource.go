...
func EnsureControllerDeploymentExists(
	...
	deployment := EnsureKubernetesObjectExists(ctx, k8sClient, types.NamespacedName{Namespace: controllerDeployment.Namespace, Name: controllerDeployment.Name}, &appsv1.Deployment{}, controllerDeployment)
...
func LoadOperatorDeploymentOrFail(
	...
	if err := k8sClient.Get(ctx, types.NamespacedName{Namespace: Dash0OperatorNamespace, Name: Dash0OperatorDeploymentName}, deployment); err != nil {
