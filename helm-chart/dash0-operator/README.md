...
is needed to generate profiling data, like the [OpenTelemetry eBPF profiler](https://github.com/open-telemetry/opentelemetry-ebpf-profiler).
...
```console
kubectl apply --server-side -f https://raw.githubusercontent.com/prometheus-operator/prometheus-operator/v0.90.0/example/prometheus-operator-crd/monitoring.coreos.com_prometheusrules.yaml
```
