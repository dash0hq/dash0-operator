...
func (in *Dash0MonitoringSpec) DeepCopyInto(out *Dash0MonitoringSpec) {
	*out = *in
	...
	if in.TelemetryFilter != nil {
		in, out := &in.TelemetryFilter, &out.TelemetryFilter
		*out = new(TelemetryFilter)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *LogFilter) DeepCopyInto(out *LogFilter) {
	*out = *in
	in.LogRecordFilter.DeepCopyInto(&out.LogRecordFilter)
}
...
func (in *MetricFilter) DeepCopyInto(out *MetricFilter) {
	*out = *in
	in.MetricFilter.DeepCopyInto(&out.MetricFilter)
	in.DataPointFilter.DeepCopyInto(&out.DataPointFilter)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectTypeFilter) DeepCopyInto(out *ObjectTypeFilter) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectTypeFilter.
func (in *ObjectTypeFilter) DeepCopy() *ObjectTypeFilter {
	if in == nil {
		return nil
	}
	out := new(ObjectTypeFilter)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TelemetryFilter) DeepCopyInto(out *TelemetryFilter) {
	*out = *in
	if in.Traces != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TelemetryFilter.
func (in *TelemetryFilter) DeepCopy() *TelemetryFilter {
	if in == nil {
		return nil
	}
	out := new(TelemetryFilter)
...
func (in *TraceFilter) DeepCopyInto(out *TraceFilter) {
	*out = *in
	in.SpanFilter.DeepCopyInto(&out.SpanFilter)
	in.SpanEventFilter.DeepCopyInto(&out.SpanEventFilter)
}
