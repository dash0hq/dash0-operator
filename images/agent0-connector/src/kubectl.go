...
// --context, --as*, --token, ...), weaken transport security, read local files (-f, -k), stream (-w, --follow), or log
// the HTTP request and response bodies and thereby the contents of any resource (-v at verbosity 8 and above).
