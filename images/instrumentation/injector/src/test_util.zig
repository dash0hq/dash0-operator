...
/// Resets std.c.environ to the given value, and resets the print flags to their original value. This function is meant
/// to be used after doing clearStdCEnviron or setStdCEnviron earlier, to restore the original environment after the
/// test is done, and to reset print flags that might have been changed during a test.
pub fn resetStdCEnvironAndPrintFlags(original_environ: [*:null]?[*:0]u8) void {
