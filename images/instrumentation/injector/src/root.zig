...
var my_environ_buffer: [131072]u8 = [_]u8{0} ** 131072;
const my_environ_buffer_ptr: *[131072]u8 = &my_environ_buffer;
export var __my_environ: [*]u8 = my_environ_buffer_ptr;
...
fn _initEnviron() !void {
    ...
    for (res_attrs.otel_resource_attributes_env_var_name) |c| {
        ...
        environ_idx += 1;
        my_environ_buffer[environ_idx] = c;
        environ_idx += 1;
    }
    environ_buffer[environ_idx] = '=';
    my_environ_buffer[environ_idx] = '=';
    environ_idx += 1;
    ...
    my_environ_buffer[environ_idx] = 0;
    environ_idx += 1;
    ...
    std.debug.print("root.zig#_initEnviron: XXX __environ inner pointer: {x}\n", .{@intFromPtr(environ_buffer_ptr)});
