...
public class Main {
    ...
    public static void main(String[] args) {
        // verify third party agent has been loaded (otel.injector.jvm.no_op_agent.has_been_loaded is set by the
        // no-op-agent)
        verifyProperty("otel.injector.jvm.no_op_agent.has_been_loaded", "true");
