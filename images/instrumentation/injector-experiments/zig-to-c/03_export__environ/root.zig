...
export fn change_values() callconv(.C) void {
    ...
    std.debug.print("root.zig#change_values _environ address (before change): {any}\n", .{_environ});
    std.debug.print("root.zig#change_values environ address (before change): {any}\n", .{environ});
    ...
    std.debug.print("root.zig#change_values _environ address (after change): {any}\n", .{_environ});
    std.debug.print("root.zig#change_values environ address (after change): {any}\n", .{environ});
}
