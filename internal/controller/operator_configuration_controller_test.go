...
var _ = Describe(
	"The operation configuration resource controller", Ordered, func() {
		...
		Describe("redactOperatorConfiguration", func() {
			reconcilerForTest := &OperatorConfigurationReconciler{}

			It("should clear ManagedFields", func() {
				original := dash0v1alpha1.Dash0OperatorConfiguration{}
				original.ManagedFields = []metav1.ManagedFieldsEntry{{Manager: "some-manager"}}

				redacted := reconcilerForTest.redactOperatorConfiguration(original)
